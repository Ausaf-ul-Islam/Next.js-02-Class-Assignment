        ...
        >
          <ul className="flex flex-col md:flex-row md:space-x-6 space-y-4 md:space-y-0 p-4 md:p-0">
            ...
            <li className="flex items-center">
              <Link
                href="#contact"
                className="bg-white hover:bg-gray-200 text-black font-semibold py-2 px-4 rounded-full shadow-lg hover:shadow-xl transition duration-400 transform hover:scale-105"
              >
                Contact Us
              </Link>
            </li>
